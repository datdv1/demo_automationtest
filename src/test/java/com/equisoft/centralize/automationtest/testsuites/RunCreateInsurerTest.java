...
@CucumberOptions(
        features = "src/test/java/com/equisoft/centralize/automationtest/features/insurer/CreateInsurer.feature",
        plugin = {
                "pretty",
                "json:target/cucumber_json_reports/create-insurer-feature.json",
                "html:target/create-insurer-feature.html"
        },
        glue = {
...
public class RunCreateInsurerTest {
}
